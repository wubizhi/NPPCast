"""
Experiment 6 Code for NPP Prediction (OBS Fine-Tuning of GIAF-trained Models)

Key Steps:
1. Data Loading & MinMax Scaling (OBS Data)
2. Loading Pre-trained GIAF Models (UNet, VNet, AttUNet, R2UNet)
...
# Directory for loading pre-trained GIAF model weights
...
def making_Prediction(
    ...
    """
    Predict in batches to avoid OOM and progress-bar math errors.

    Args:
        model: A compiled Keras model for inference.
        input_sequence: np.ndarray, shape [N, W, H, frames].
        batch_size: Number of samples per call to model.predict.
        verbose: Verbosity level passed to model.predict (0 silences the bar).

    Returns:
        np.ndarray: Predictions concatenated across the first (batch) axis,
                    shape [N, W, H, output_frames].
    """
    N = input_sequence.shape[0]

    # If there's nothing to predict, return an empty array with the right 4‑D shape
    if N == 0:
        # model.output_shape is e.g. (None, W, H, out_frames)
        _, W, H, out_f = model.output_shape
        return np.zeros((0, W, H, out_f), dtype=np.float32)

    preds = []
    for start in range(0, N, batch_size):
        end = start + batch_size
        batch = input_sequence[start:end]
        batch_pred = model.predict(batch, verbose=verbose)
...
if __name__ == "__main__":
    ...
    for model_key in model_name_list:
        ...
        # np.save(os.path.join("./AMD_Archives/npp_outputs/OBS_Input_GIAF_FineTune", f"CbPM_Input_GIAF_MinMax{model_name_str}.npy"), cbpm_pred)
        ...
        # Save results
        # np.save(f"./AMD_Archives/npp_outputs/OBS_Input_GIAF_FineTune/CbPM_Input_GIAF_Pred{model_name_str}.npy", cbpm_total_pred)
        showcase_dir = "./AMD_Archives/npp_outputs/OBS_Input_GIAF_FineTune/ShowCases"
        ...
        cbpm_nc_file = f"./AMD_Archives/npp_outputs/OBS_Input_GIAF_FineTune/CbPM_Input_GIAF_Pred{model_name_str}.nc"
        ...
        # np.save(os.path.join("./AMD_Archives/npp_outputs/OBS_Input_GIAF_FineTune", f"EVGPM_Input_GIAF_MinMax{model_name_str}.npy"), evgpm_pred)
        ...
        # np.save(f"./AMD_Archives/npp_outputs/OBS_Input_GIAF_FineTune/EVGPM_Input_GIAF_Pred{model_name_str}.npy", evgpm_total_pred)
        ...
        evgpm_ds.to_netcdf(f"./AMD_Archives/npp_outputs/OBS_Input_GIAF_FineTune/EVGPM_Input_GIAF_Pred{model_name_str}.nc")
        ...
        # np.save(os.path.join("./AMD_Archives/npp_outputs/OBS_Input_GIAF_FineTune", f"SVGPM_Input_GIAF_MinMax{model_name_str}.npy"), svgpm_pred)
        ...
        # np.save(f"./AMD_Archives/npp_outputs/OBS_Input_GIAF_FineTune/SVGPM_Input_GIAF_Pred{model_name_str}.npy", svgpm_total_pred)
        ...
        svgpm_ds.to_netcdf(f"./AMD_Archives/npp_outputs/OBS_Input_GIAF_FineTune/SVGPM_Input_GIAF_Pred{model_name_str}.nc")
        ...
        # np.save(os.path.join("./AMD_Archives/npp_outputs/OBS_Input_GIAF_FineTune", f"MEAN_Input_GIAF_MinMax{model_name_str}.npy"), mean_pred)
        ...
        # np.save(f"./AMD_Archives/npp_outputs/OBS_Input_GIAF_FineTune/MEAN_Input_GIAF_Pred{model_name_str}.npy", mean_total_pred)
        ...
        mean_ds.to_netcdf(f"./AMD_Archives/npp_outputs/OBS_Input_GIAF_FineTune/MEAN_Input_GIAF_Pred{model_name_str}.nc")
        ...
        # np.save(f"./AMD_Archives/npp_outputs/OBS_Input_GIAF_FineTune/full_CbPM_Input_GIAF_Pred{model_name_str}.npy", cbpm_total_pred_full)
        cbpm_ds_full.to_netcdf(f"./AMD_Archives/npp_outputs/OBS_Input_GIAF_FineTune/full_CbPM_Input_GIAF_Pred{model_name_str}.nc")
        ...
        # np.save(f"./AMD_Archives/npp_outputs/OBS_Input_GIAF_FineTune/full_EVGPM_Input_GIAF_Pred{model_name_str}.npy", evgpm_total_pred_full)
        evgpm_ds_full.to_netcdf(f"./AMD_Archives/npp_outputs/OBS_Input_GIAF_FineTune/full_EVGPM_Input_GIAF_Pred{model_name_str}.nc")
        ...
        # np.save(f"./AMD_Archives/npp_outputs/OBS_Input_GIAF_FineTune/full_SVGPM_Input_GIAF_Pred{model_name_str}.npy", svgpm_total_pred_full)
        svgpm_ds_full.to_netcdf(f"./AMD_Archives/npp_outputs/OBS_Input_GIAF_FineTune/full_SVGPM_Input_GIAF_Pred{model_name_str}.nc")
        ...
        # np.save(f"./AMD_Archives/npp_outputs/OBS_Input_GIAF_FineTune/full_MEAN_Input_GIAF_Pred{model_name_str}.npy", mean_total_pred_full)
        mean_ds_full.to_netcdf(f"./AMD_Archives/npp_outputs/OBS_Input_GIAF_FineTune/full_MEAN_Input_GIAF_Pred{model_name_str}.nc")
