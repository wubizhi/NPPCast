"""
Experiment 1 Code for NPP Prediction (FOSI2-based Training)

This script demonstrates:
1. Data loading & MinMax scaling
2. Custom model construction (UNet, VNet, AttUNet, R2UNet, NPPCast)
...
# START_DATE = '1/1/1952' # FOSI1: 1948+4
START_DATE = '1/1/1962' # FOSI2: 1958+4

# File paths
# NPP_FILE = "../NPP_Data/g.e11_LENS.GECOIAF.T62_g16.009.pop.h.NPP.024901-031612.nc"
# SPNPP_FILE = "../NPP_Data/b.e11.BRCP85C5CNBDRD.f09_g16.001.pop.h.photoC_diaz.208101-210012.nc"
NPP_FILE="./FOSI2/CESM2_FOSI_NPP_surface.nc"

SAVE_DIR_MODELS = "./AMD_Archives/Model_UNet_family_FOSI/"
SAVE_DIR_OUTPUTS = "./AMD_Archives/npp_outputs/FOSI_Input_FOSI_Model/"
SAVE_DIR_SHOWCASE = "./AMD_Archives/npp_outputs/FOSI_Input_FOSI_Model/ShowCases/"
...
def train_model(
    ...
    if val_data is None:
        ...
        reduce_lr_loss = ReduceLROnPlateau(
            monitor='loss', factor=0.1, patience=10, verbose=1, mode='min', min_delta=1e-4
        )
        ...
        reduce_lr_loss = ReduceLROnPlateau(
            monitor='val_loss', factor=0.1, patience=10, verbose=1, mode='min', min_delta=1e-4
        )
...
if __name__ == "__main__":
    ...
    for model_key in model_name_list:
        ...
        # np.save(
        #     os.path.join(SAVE_DIR_OUTPUTS, f"FOSI_Input_FOSI_MinMax_{model_name_str}.npy"),
        #     predictions
        # )
        ...
        ds_10year_file = f"FOSI_Model_Pred_NPP_10y_{model_name_str}"
        ...
        # np.save(
        #     os.path.join(SAVE_DIR_SHOWCASE, f"FOSI_Model_Pred_10year_{model_name_str}.npy"),
        #     pred_last_10year
        # )
        # np.save(
        #     os.path.join(SAVE_DIR_SHOWCASE, f"FOSI_Model_Real_10year_{model_name_str}.npy"),
        #     real_npp
        # )
        # np.save(
        #     os.path.join(SAVE_DIR_SHOWCASE, f"FOSI_Model_Diff_10year_{model_name_str}.npy"),
        #     diff_npp
        # )
