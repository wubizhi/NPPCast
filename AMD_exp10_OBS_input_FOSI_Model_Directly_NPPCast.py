"""
Experiment 2 Code for NPP Prediction (Directly Using OBS Data with FOSI-trained Models)
...
4. Predicting Output (Last 10 years or Full time span), Inverse Scaling, Saving Results
...
SAVE_DIR_OUTPUTS = "./AMD_Archives/npp_outputs/OBS_Input_FOSI_Directly/"
...
def making_Prediction(model: tf.keras.Model, x_input: np.ndarray) -> np.ndarray:
    """
...
def Inversing_the_PredData(
    ...
    # lon_vals = xr.open_dataset('./Common_data/CESM_Parameter.nc')['TLONG'].values
    # lat_vals = xr.open_dataset('./Common_data/CESM_Parameter.nc')['TLAT'].values
    ...
    ds = xr.Dataset(
        ...
        attrs=dict(description="NPP Prediction from OBS input using FOSI-trained model.")
    )
...
if __name__ == "__main__":
    ...
    for model_key in model_name_list:
        ...
        np.save(os.path.join(SAVE_DIR_OUTPUTS, f"CbPM_Input_FOSI_MinMax{model_name_str}.npy"), cbpm_pred)
        ...
        # Save results
        # np.save(os.path.join(SAVE_DIR_OUTPUTS, f"CbPM_Input_FOSI_Pred{model_name_str}.npy"), cbpm_total_pred)
        ...
        cbpm_ds.to_netcdf(os.path.join(SAVE_DIR_OUTPUTS, f"CbPM_Input_FOSI_Pred{model_name_str}.nc"))
        ...
        # np.save(os.path.join(SAVE_DIR_OUTPUTS, f"EVGPM_Input_FOSI_MinMax{model_name_str}.npy"), evgpm_pred)
        ...
        # np.save(os.path.join(SAVE_DIR_OUTPUTS, f"EVGPM_Input_FOSI_Pred{model_name_str}.npy"), evgpm_total_pred)
        ...
        evgpm_ds.to_netcdf(os.path.join(SAVE_DIR_OUTPUTS, f"EVGPM_Input_FOSI_Pred{model_name_str}.nc"))
        ...
        # np.save(os.path.join(SAVE_DIR_OUTPUTS, f"SVGPM_Input_FOSI_MinMax{model_name_str}.npy"), svgpm_pred)
        ...
        # np.save(os.path.join(SAVE_DIR_OUTPUTS, f"SVGPM_Input_FOSI_Pred{model_name_str}.npy"), svgpm_total_pred)
        ...
        svgpm_ds.to_netcdf(os.path.join(SAVE_DIR_OUTPUTS, f"SVGPM_Input_FOSI_Pred{model_name_str}.nc"))
        ...
        # np.save(os.path.join(SAVE_DIR_OUTPUTS, f"MEAN_Input_FOSI_MinMax{model_name_str}.npy"), mean_pred)
        ...
        # np.save(os.path.join(SAVE_DIR_OUTPUTS, f"MEAN_Input_FOSI_Pred{model_name_str}.npy"), mean_total_pred)
        ...
        mean_ds.to_netcdf(os.path.join(SAVE_DIR_OUTPUTS, f"MEAN_Input_FOSI_Pred{model_name_str}.nc"))
        ...
        # np.save(os.path.join(SAVE_DIR_OUTPUTS, f"full_CbPM_Input_FOSI_Pred{model_name_str}.npy"), cbpm_total_pred_full)
        cbpm_ds_full.to_netcdf(os.path.join(SAVE_DIR_OUTPUTS, f"full_CbPM_Input_FOSI_Pred{model_name_str}.nc"))
        ...
        # np.save(os.path.join(SAVE_DIR_OUTPUTS, f"full_EVGPM_Input_FOSI_Pred{model_name_str}.npy"), evgpm_total_pred_full)
        evgpm_ds_full.to_netcdf(os.path.join(SAVE_DIR_OUTPUTS, f"full_EVGPM_Input_FOSI_Pred{model_name_str}.nc"))
        ...
        # np.save(os.path.join(SAVE_DIR_OUTPUTS, f"full_SVGPM_Input_FOSI_Pred{model_name_str}.npy"), svgpm_total_pred_full)
        svgpm_ds_full.to_netcdf(os.path.join(SAVE_DIR_OUTPUTS, f"full_SVGPM_Input_FOSI_Pred{model_name_str}.nc"))
        ...
        # np.save(os.path.join(SAVE_DIR_OUTPUTS, f"full_MEAN_Input_FOSI_Pred{model_name_str}.npy"), mean_total_pred_full)
        mean_ds_full.to_netcdf(os.path.join(SAVE_DIR_OUTPUTS, f"full_MEAN_Input_FOSI_Pred{model_name_str}.nc"))
